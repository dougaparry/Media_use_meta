...
```
# Side by side
back to change background colour...
```{r}
png(file='figures/combined_funnel_side_by_side.png', units = "in", height=8, width=18, res=300)
